...
<head>
    ...
    <link rel="shortcut icon" type="image/x-icon" href="{{url('/assets/img/gbs-favicon.png')}}">
    <link rel="shortcut icon" type="image/png" href="{{url('/assets/img/gbs-favicon.png')}}">
    ...
    <link rel="stylesheet" type="text/css" href="{{url('/assets/vendors/css/chartist.min.css')}}">  

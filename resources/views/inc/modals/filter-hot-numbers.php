        <!-- Filter Highest Bet -->
        <div class="modal fade text-left" id="hotNumbers" tabindex="-1" role="dialog" aria-labelledby="newOutlet" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title" id="hotNumbersTitle">Filter Hot Numbers</h4>
                    ...
                    <form action="#">
                        <div class="modal-body">       
                            ...
                            <div class="form-group">
                                <label>Limit the number of Hot Numbers</label>
                                <input type="text" class="form-control" id="basicInput" placeholder="Input Limit">                             
                            </div>                                                                      
                        </div>

        <!-- Filter Transactions -->
        <div class="modal fade text-left" id="filterTransaction" tabindex="-1" role="dialog" aria-labelledby="newOutlet" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title" id="newOutlet">Filter Transaction</h4>

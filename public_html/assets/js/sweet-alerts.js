...
$(document).ready(function () {
	...
	$('#confirm-delete-user').on('click', function () {
		swal({
			title: 'Are you sure?',
			text: "This user will be removed in the system!",
			type: 'warning',
			showCancelButton: true,
			confirmButtonColor: '#0CC27E',
			cancelButtonColor: '#FF586B',
			...
			swal(
				'Deleted!',
				'User has been successfully removed in the system.',
				'success'
			)
		}, function (dismiss) {
			// dismiss can be 'overlay', 'cancel', 'close', 'esc', 'timer'
	...
	// Confirm Delete Button
	$('#confirm-delete-outlet').on('click', function () {
		swal({
			title: 'Are you sure?',
			text: "This outlet will be removed in the system!",
			type: 'warning',
			showCancelButton: true,
			confirmButtonColor: '#0CC27E',
			cancelButtonColor: '#FF586B',
			...
			swal(
				'Deleted!',
				'Outlet has been successfully removed in the system.',
				'success'
			)
		}, function (dismiss) {
			// dismiss can be 'overlay', 'cancel', 'close', 'esc', 'timer'
